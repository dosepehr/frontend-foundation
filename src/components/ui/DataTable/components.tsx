...
import { AlertCircleIcon, ArrowDownIcon, ArrowUpDownIcon, ArrowUpIcon, InboxIcon, SearchIcon, SearchXIcon } from 'lucide-react'
...
function DataTablePagination({ current, total, setPage, limit, setLimit }: DataTablePaginationProps) {
