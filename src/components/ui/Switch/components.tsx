    ...
    'peer group/switch relative inline-flex shrink-0 items-center rounded-full border border-transparent transition-all outline-none after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 data-disabled:cursor-not-allowed data-disabled:opacity-50 data-[size=default]:h-[18.4px] data-[size=default]:w-[32px] data-[size=sm]:h-[14px] data-[size=sm]:w-[24px]',
    {
        variants: {
            variant: {
                ...
                success:     'data-checked:bg-success data-unchecked:bg-input dark:data-unchecked:bg-input/80',
                warning:     'data-checked:bg-warning data-unchecked:bg-input dark:data-unchecked:bg-input/80',
                destructive: 'data-checked:bg-destructive data-unchecked:bg-input dark:data-unchecked:bg-input/80',
...
function Switch({ className, variant, size = 'default', label, id, required, ...props }: SwitchProps) {
    return (
        <Label className='flex items-center gap-2 w-fit font-normal' required={required}>
