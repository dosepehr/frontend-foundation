...
describe('Item', () => {
    ...
    it('renders as child element when asChild is true', () => {
        ...
        expect(
            screen.getByRole('button', { name: 'Button item' }),
        ).toBeInTheDocument();
    });
});
...
describe('ItemMedia', () => {
    ...
    it('reflects variant via data-variant', () => {
        ...
        expect(
            container.querySelector('[data-slot="item-media"]'),
        ).toHaveAttribute('data-variant', 'avatar');
    });
...
describe('ItemEnd', () => {
    it('has data-slot="item-end"', () => {
        ...
        expect(
            container.querySelector('[data-slot="item-end"]'),
        ).toBeInTheDocument();
    });
...
describe('ItemWrapper', () => {
    ...
    it('passes variant and size to Item', () => {
        const { container } = render(
            <ItemWrapper variant="outline" size="sm" />,
        );
        expect(container.querySelector('[data-slot="item"]')).toHaveAttribute(
            'data-size',
            'sm',
...
describe('Item outline + interactive', () => {
    it('renders as button when variant="outline" and onClick is provided', () => {
        render(
            <Item variant="outline" onClick={vi.fn()}>
                Click
            </Item>,
        );
        expect(screen.getByRole('button')).toBeInTheDocument();
