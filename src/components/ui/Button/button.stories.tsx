    ...
    render: () => (
        <div className='flex flex-wrap items-center gap-3'>
            {(['xs', 'sm', 'default', 'lg'] as const).map((size) => (
                <ButtonWrapper key={size} size={size}>
                    {size}
                </ButtonWrapper>
            ))}
        </div>
    ...
    render: () => (
        <div className='flex flex-wrap items-center gap-3'>
            {(['icon-xs', 'icon-sm', 'icon', 'icon-lg'] as const).map((size) => (
                <ButtonWrapper key={size} size={size} variant='outline'>
...
export const WithIcon: Story = {
    render: () => (
        <div className='flex flex-wrap items-center gap-3'>
            ...
            <ButtonWrapper variant='default' size='default'>
            ...
            <ButtonWrapper variant='destructive' size='sm'>
            ...
            <ButtonWrapper variant='secondary' size='lg'>
