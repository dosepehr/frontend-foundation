...
describe('BubbleGroup', () => {
    ...
    it('forwards className', () => {
        ...
        expect(
            container.querySelector('[data-slot="bubble-group"]')?.className,
...
describe('Bubble', () => {
    ...
    it('forwards className', () => {
        ...
        expect(
            container.querySelector('[data-slot="bubble"]')?.className,
        ).toContain('extra');
    });
...
describe('BubbleContent', () => {
    ...
    it('renders as a div by default', () => {
        const { container } = render(<BubbleContent />);
        expect(
            container.querySelector('div[data-slot="bubble-content"]'),
        ).toBeTruthy();
    });
...
describe('BubbleReactions', () => {
    ...
    it.each<'top' | 'bottom'>(['top', 'bottom'])(
        ...
        (side) => {
            ...
            expect(
                container.querySelector(`[data-side="${side}"]`),
            ).toBeTruthy();
        },
    );
...
describe('BubbleWrapper', () => {
    ...
    >([
        ...
        const { container } = render(
            <BubbleWrapper variant={variant}>text</BubbleWrapper>,
        );
        expect(
            container.querySelector(`[data-variant="${variant}"]`),
        ).toBeTruthy();
    ...
    it.each<'start' | 'end'>(['start', 'end'])(
        'passes align="%s" to Bubble',
        (align) => {
            const { container } = render(
                <BubbleWrapper align={align}>text</BubbleWrapper>,
            );
            expect(
                container.querySelector(`[data-align="${align}"]`),
            ).toBeTruthy();
    ...
    it('forwards className to Bubble', () => {
        const { container } = render(
            <BubbleWrapper className="my-class">text</BubbleWrapper>,
        );
        expect(
            container.querySelector('[data-slot="bubble"]')?.className,
        ).toContain('my-class');
    ...
    it('passes reactionsSide to BubbleReactions', () => {
        const { container } = render(
            <BubbleWrapper reactions={<span>👍</span>} reactionsSide="top">
                text
            </BubbleWrapper>,
        );
    ...
    it('passes reactionsAlign to BubbleReactions', () => {
        const { container } = render(
            <BubbleWrapper reactions={<span>👍</span>} reactionsAlign="start">
                text
            </BubbleWrapper>,
        );
        expect(
            container.querySelector(
                '[data-align="start"][data-slot="bubble-reactions"]',
            ),
        ).toBeTruthy();
    });
