...
import { CircleFadingPlusIcon, BluetoothIcon, Trash2Icon, InfoIcon, CheckCircleIcon, AlertTriangleIcon } from 'lucide-react'
...
const meta: Meta<typeof AlertDialogWrapper> = {
    ...
    argTypes: {
        ...
        intent: {
            control: 'select',
            options: ['default', 'destructive', 'warning', 'info', 'success'] satisfies AlertDialogIntent[],
            description: 'Sets media color scheme and default action button variant',
        },
        confirmLabel: {
            control: 'text',
...
export const Info: Story = {
    args: {
        ...
        description: 'A new version is available. Restart the app to apply the latest updates.',
        media: <InfoIcon />,
